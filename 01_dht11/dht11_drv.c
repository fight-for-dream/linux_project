 ...
 * preemption; hardware interrupts are still enabled.
 */
			 ...
			 struct dht11_sample *sample)
{
	...
	/*
	 * Do not let another normal task preempt this process while receiving the
	 * microsecond waveform. Hardware interrupts remain enabled.
	 */
	preempt_disable();
